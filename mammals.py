...
# a method that returns whether the animal can roar if certain conditions are met:
    def roar(self):
        if self.mood == "happy":
            print(self.name + " is purring")
        elif self.mood != "happy":
            print(self.name + " is Roaringgg")
# a method that returns whether the animal is play fighting if certain conditions are met:    
    def play_fighting(self):
        if self.mood == "happy":
            print(self.name + " is play fighting")
        elif self.mood != "happy":
            print(self.name + " is ready to kill. Be careful")
# a method that return where the animal is eating his prey if certain conditions are met:   
