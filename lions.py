...
class Lion(Big_Cats):
    def __init__(self,name,species,breathing=True,hunt=True,mood="happy",climbing_ability=True,hunter="female",mane=True,pride=0):
        ...
        self.mane = mane
        self.pride = pride 
# a method that determines whether the lion will go on a hunt depending on certain whether certain conditions are met:
...
# a method that determines whether the lion with protect his pride if certain conditions are met: 
